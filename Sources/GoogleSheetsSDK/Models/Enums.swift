...
public enum MajorDimension: String, Codable, CaseIterable, Sendable {
...
public enum ValueRenderOption: String, Codable, CaseIterable, Sendable {
...
public enum ValueInputOption: String, Codable, CaseIterable, Sendable {
...
public enum DateTimeRenderOption: String, Codable, CaseIterable, Sendable {
...
public enum RecalculationInterval: String, Codable, CaseIterable, Sendable {
