...
public struct Spreadsheet: Codable, Equatable, Sendable {
...
public struct SpreadsheetProperties: Codable, Equatable, Sendable {
...
public struct SheetProperties: Codable, Equatable, Sendable {
...
/// The type of sheet
public enum SheetType: String, Codable, CaseIterable, Sendable {
...
public struct IterativeCalculationSettings: Codable, Equatable, Sendable {
    public init() {}
}

/// Placeholder for SpreadsheetTheme
public struct SpreadsheetTheme: Codable, Equatable, Sendable {
    public init() {}
}

/// Placeholder for NamedRange
public struct NamedRange: Codable, Equatable, Sendable {
    public init() {}
}

/// Placeholder for DeveloperMetadata
public struct DeveloperMetadata: Codable, Equatable, Sendable {
    public init() {}
}

/// Placeholder for DataSource
public struct DataSource: Codable, Equatable, Sendable {
    public init() {}
}

/// Placeholder for DataSourceRefreshSchedule
public struct DataSourceRefreshSchedule: Codable, Equatable, Sendable {
    public init() {}
}

/// Placeholder for GridData
public struct GridData: Codable, Equatable, Sendable {
    public init() {}
}

/// Placeholder for GridRange
public struct GridRange: Codable, Equatable, Sendable {
    public init() {}
}

/// Placeholder for ConditionalFormatRule
public struct ConditionalFormatRule: Codable, Equatable, Sendable {
    public init() {}
}

/// Placeholder for FilterView
public struct FilterView: Codable, Equatable, Sendable {
    public init() {}
}

/// Placeholder for ProtectedRange
public struct ProtectedRange: Codable, Equatable, Sendable {
    public init() {}
}

/// Placeholder for BasicFilter
public struct BasicFilter: Codable, Equatable, Sendable {
    public init() {}
}

/// Placeholder for EmbeddedChart
public struct EmbeddedChart: Codable, Equatable, Sendable {
    public init() {}
}

/// Placeholder for BandedRange
public struct BandedRange: Codable, Equatable, Sendable {
    public init() {}
}

/// Placeholder for DimensionGroup
public struct DimensionGroup: Codable, Equatable, Sendable {
    public init() {}
}

/// Placeholder for Slicer
public struct Slicer: Codable, Equatable, Sendable {
    public init() {}
}
...
public struct GridProperties: Codable, Equatable, Sendable {
    public init() {}
}
...
public struct ColorStyle: Codable, Equatable, Sendable {
    public init() {}
}

/// Placeholder for DataSourceSheetProperties
public struct DataSourceSheetProperties: Codable, Equatable, Sendable {
    public init() {}
}
...
public struct SpreadsheetCreateRequest: Codable, Equatable, Sendable {
...
public struct BatchUpdateRequest: Codable, Equatable, Sendable {
...
public struct BatchUpdateSpreadsheetResponse: Codable, Equatable, Sendable {
