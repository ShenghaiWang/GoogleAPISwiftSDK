...
public struct ValueRange: Codable, Equatable, Sendable {
    ...
    public init(range: String? = nil, majorDimension: MajorDimension? = nil, values: [[Sendable]]? = nil) {
        self.range = range
        self.majorDimension = majorDimension
...
public struct UpdateValuesResponse: Codable, Equatable, Sendable {
...
public struct AppendValuesResponse: Codable, Equatable, Sendable {
    /// The spreadsheet the updates were applied to
    public let spreadsheetId: String?
...
public struct ClearValuesResponse: Codable, Equatable, Sendable {
    /// The spreadsheet the updates were applied to
    public let spreadsheetId: String?
...
public struct BatchGetValuesResponse: Codable, Equatable, Sendable {
...
public struct BatchUpdateValuesResponse: Codable, Equatable, Sendable {
    /// The spreadsheet the updates were applied to
    public let spreadsheetId: String?
...
public struct ValueUpdateOptions: Equatable, Sendable {
