...
public enum GoogleSheetsError: Error, LocalizedError, Equatable, Sendable {
    ...
    case apiError(code: Int, message: String, details: [String: String]?)
    ...
    static func fromHTTPResponse(statusCode: Int, data: Data?) -> GoogleSheetsError {
        ...
        case 429:
            ...
            if let details = errorDetails,
               let retryAfterValue = Double(details["retryAfter"] ?? "") {
